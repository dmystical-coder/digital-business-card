    ...
    return (
        <div className="info">
            ...
            <div className="info--btn-group">
                <a href="mailto:dmystical.coder@gmail.com" target='_blank' className="info--btn-group_btn">
                    <img src={Mail} alt="mail icon" />
                    <span className="btn--text">Email</span>
                </a>
                <a href="https://www.linkedin.com/in/abdulsalam-baruwa" target='_blank' className="info--btn-group_btn">
